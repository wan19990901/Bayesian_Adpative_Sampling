...
base_path="./iter_dpo_llama_reward"
mkdir $base_path
...
EOT
    ...
    accelerate launch --config_file ./configs/zero3.yaml dpo_iteration/run_dpo.py llama_dpo_config.yaml
}
...
do
    ...
    if [ $i -eq 1 ]; then
        ...
        model_path="Llama_iter${previous_iteration}"
    fi

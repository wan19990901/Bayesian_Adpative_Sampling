...
# Step 3: filter examples with ood rounds or mistakes in second-last round
...
# Step 4: delete samples that are too long
...
ds_new = ds_new.remove_columns([col for col in ds_new.column_names if col not in columns_to_keep])

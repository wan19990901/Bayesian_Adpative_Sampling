...
base_path="./iter_dpo_qwen_reward"
mkdir $base_path
...
EOT
    ...
    accelerate launch --config_file ./configs/zero3.yaml dpo_iteration/run_dpo.py qwen_dpo_config.yaml
}

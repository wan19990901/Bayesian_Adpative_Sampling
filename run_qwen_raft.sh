...
EOT
    ...
    accelerate launch --config_file ./configs/zero3.yaml dpo_iteration/run_dpo.py qwen_raft_config.yaml
}
...
for i in {1..9}
do
    iteration_name="Qwen_raft_iter${i}"
    ...
    if [ $i -eq 1 ]; then
        ...
        model_path="Qwen_raft_iter${previous_iteration}"
    fi
